...
#change into the current directory of this script
cd "${0%/*}"
...
#
# Usage: ./makeSymLink.sh [Torrent Id] [File Name or Directory] [Parent directory where this file or directory is located]
# ex: ./makeSymLink.sh "South Park" South.Park.S19E03.HDTV.x264-KILLERS.mp4 /home/someuser/files/transfer/tv
...
EOM
  ...
  echo ${json} | curl -sS -H "Accept: application/json" -H "Content-type: application/json" -d @-  ${syncServer}/seedboxCallback
